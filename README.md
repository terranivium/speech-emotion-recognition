...
#### Usage guide:
	+ To download datasets requires Git-LFS
	...
	+ Run requirements.txt
		...
		- (NOTE: if using collab, portaudio install will be required, install via brew),
		"brew install portaudio"

	+ (not required) Use speech_emotion_recognition notebook to train, validate and test model
	
	+ To simply generate results and plots for PyTorch implementation, skip to and run cells in the 'Testing' section of speech_emotion_recognition.ipynb, this will load the provided 'best model' state.
